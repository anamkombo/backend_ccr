...
router.post("/assy/edit", async (req, res) => {
  const { elbow_1_planning, elbow_1_actual, ball_1_planning, ball_1_actual, hev_1_planning, hev_1_actual, elbow_2_planning, elbow_2_actual, ball_2_planning, ball_2_actual, hev_2_planning, hev_2_actual } = req.body;
